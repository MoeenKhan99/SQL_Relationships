-- write your quereies here---

--SELECT * FROM owners o FULL OUTER JOIN 
...
--SELECT first_name, last_name, ROUND(AVG(price)) AS 
--average_price, COUNT(owner_id) FROM owners o JOIN
--vehicles v ON o.id=v.owner_id GROUP BY (first_name, last_name)
